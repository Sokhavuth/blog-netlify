	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/category/delete/_id_/_server.js'))
			},
			{
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/category/paginate/_page_/_server.js'))
			},
			{
				id: "/admin/logout",
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/page/delete/_id_/_server.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"page","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/page/paginate/_page_/_server.js'))
			},
			{
				id: "/admin/post",
				pattern: /^\/admin\/post\/?$/,
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/post/delete/_id_/_server.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"page","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/post/paginate/_page_/_server.js'))
			},
			{
				id: "/admin/search",
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/setting/delete/_id_/_server.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"page","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/setting/paginate/_page_/_server.js'))
			},
			{
				id: "/admin/upload",
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/user/delete/_id_/_server.js'))
			},
			{
			...
			},
			{
				...
				params: [{"name":"page","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/admin/user/paginate/_page_/_server.js'))
			},
			{
				id: "/login",
				pattern: /^\/login\/?$/,
